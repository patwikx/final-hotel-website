      ...
      <div className="container mx-auto px-6">
              ...
              <Card className="overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 bg-white border-0 h-full">
                ...
                <div className="relative h-64 overflow-hidden">
                  <motion.img
                    ...
                    src={roomType.primaryImage || getRoomTypeImage(roomType.type)}
                ...
                <CardContent className="p-6">
                  ...
                  >
                    <Link href={`/properties/${property.slug}/rooms`} className="flex items-center justify-center gap-2">
        ...
        >
          <Button 
            asChild
            size="lg"
            className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-amber-500/25 transition-all duration-300"
          >
