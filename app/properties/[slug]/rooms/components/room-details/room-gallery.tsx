...
export function RoomGallery({ roomType }: RoomGalleryProps) {
  ...
  const getRoomTypeImages = (type: string) => {
  ...
  const images = roomType.images && roomType.images.length > 0 
    ? roomType.images 
    : getRoomTypeImages(roomType.type);
          ...
          <CardContent className="p-0">
            ...
            <div className="relative">
              ...
              <div className="relative h-96 overflow-hidden">
                ...
                <button
                  onClick={() => setIsLightboxOpen(true)}
                  className="absolute bottom-4 right-4 bg-black/50 backdrop-blur-sm border border-white/20 rounded-lg px-4 py-2 text-white hover:bg-black/70 transition-all duration-300 flex items-center gap-2"
                >
