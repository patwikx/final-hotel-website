          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-1">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-slate-400">Worldwide Corporation</p>
                </div>
              </div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/properties/tropicana-manila" className="text-slate-300 hover:text-amber-400 transition-colors duration-200 text-sm flex items-center gap-2 group">
                    <div className="w-1 h-1 bg-amber-400 rounded-full group-hover:scale-150 transition-transform"></div>
                    Tropicana Grand Manila
                  </Link>
                </li>
                <li>
                  <Link href="/properties/tropicana-cebu" className="text-slate-300 hover:text-amber-400 transition-colors duration-200 text-sm flex items-center gap-2 group">
                    <div className="w-1 h-1 bg-amber-400 rounded-full group-hover:scale-150 transition-transform"></div>
                    Tropicana Resort Cebu
                  </Link>
                </li>
                <li>
                  <Link href="/properties" className="text-slate-300 hover:text-amber-400 transition-colors duration-200 text-sm flex items-center gap-2 group">
                    <div className="w-1 h-1 bg-amber-400 rounded-full group-hover:scale-150 transition-transform"></div>
                    View All Properties
                  </Link>
                </li>
